...
//$File = "C:\Users\RMNI-Programmer\Desktop\a.csv";

 
 
  $query = "delete from tbl_movielist";
   ...
   $handle = fopen("file://D:/AgilaDS/db/$ds_info/playlist/$ds_info-playlist.csv", "r");
...
$txtdata = "D:\AgilaDS\db" ."\\" . $ds_info ."\logs\playlog.csv";
$myfile = fopen("del_report.bat", "w") or die("Unable to open file!");
$txt = "del $txtdata";
fwrite($myfile, $txt);
fclose($myfile);

$txtbin = "select DSLocationCode, DSClientCode, DSMaterial, Timestamp from tbl_playlogs into outfile 'D:/AgilaDS/db/$ds_info/logs/playlog.csv';";
