...
$File = "C:\Users\RMNI-Programmer\Desktop\a.csv";
  ...
  $query = "delete from tbl_movielist";
   ...
   $handle = fopen("file://D:/AgilaDS/playlist/$ds_info-playlist.csv", "r");
   ...
   //echo "<script>alert('Import done');</script>";
         ...
         $query = "delete from crawlers";
                ...
                $handle_crawlers = fopen("file://D:/AgilaDS/crawlers/$ds_info-crawlers.csv", "r");
   ...
   $query = "delete from crawlers where location_id = 'location_id'";
                ...
                $handle_crawler_type = fopen("file://D:/AgilaDS/crawlers/$ds_info-crawler_type.csv", "r");
